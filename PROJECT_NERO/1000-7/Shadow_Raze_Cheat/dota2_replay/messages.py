...
DOTA_USER_MESSAGE_TYPES = build_mapping(dota_usermessages_pb2, "DOTA_UM_", "CDOTAUserMsg_")

COMBINED_USER_MESSAGE_TYPES = dict(USER_MESSAGE_TYPES)
COMBINED_USER_MESSAGE_TYPES.update(DOTA_USER_MESSAGE_TYPES)

DOTA_COMBATLOGENTRY = dota_shared_enums_pb2.CMsgDOTACombatLogEntry
#EBASE_USER_MESSAGES = usermessages_pb2.EBaseUserMessages