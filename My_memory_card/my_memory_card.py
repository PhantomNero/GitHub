...
questions_list = [Question("Вы носите маску?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Вы работаете качественно?", "Всегда", "Редко", "Иногда", "Никогда"),
                  Question("Вы платите налоги?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Вы отдаёте деньги на благотворительность?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Вы даёте деньги нищим?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Вы поддерживаете президента России?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Вы вакцинированы?", "Да", "Нет", "Не хочу", "Буду вакцинирован(а)"),
                  Question("Вы переболели Covid-19?", "Да", "Нет", "Давно", "Ещё нет"),
                  Question("Вы хотите быть президентом?", "Да", "Нет", "Иногда", "Никогда"),
                  Question("Во время опроса вы отвечали чесно?", "Да", "Нет", "Иногда", "Никогда")]
